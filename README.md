...
Desde temprana edad, me he sentido atraído por el mundo de la informática, en concreto por la programación, y gracias a esto he adquirido habilidades en diversos lenguajes como Python, C y Java.
...
En la carpeta [Research Project](./research-project) encontrará mi Trabajo de Recerca en sus diferentes formatos.  
...
- **Lenguajes de Programación:** Python, C, Java, HTML, CSS y JavaScript
...
El contenido de este repositorio está regido por distintas licencias dependiendo del tipo de material. Las licencias específicas para cada tipo de contenido se detallan en la descripción de cada archivo o directorio relevante.

Para utilizar, modificar o redistribuir cualquier parte del contenido del repositorio, asegúrese de consultar la descripción correspondiente para identificar la licencia aplicable. Para solicitar permisos adicionales o para cualquier aclaración, no dude en ponerse en contacto.
